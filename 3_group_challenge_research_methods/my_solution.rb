...
# Reflect!
# This was a great challenge. On top of having to keep track of the changes that this 
# challenge got during the week, we had to work as a team.
# Even if we tried to avoid waiting on each other we end up having to hang out any 
# ways. This made me realize that if we are depending on someone’s answered its 
# better to strategize the development a little better. I think this time we didn’t read 
# what others had to do until we got in troubles and that might be the lesson here.
# How complex this challenge was I think it related more to what each one of us was 
# able to learn about Hashes and Array, plus any other thing in the dynamics of the 
# activity. For me was fun and I got to see some things about teamwork that I might 
# have missed otherwise. Our team developed interesting solution and we collaborate 
# a lot, both thing that make me feel proud. 